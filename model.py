...
from tensorflow.keras.layers import Convolution2D, MaxPooling2D, Flatten, Input, ELU
...
plt.hist(steer_db, bins= 50, color= 'green')
...
def network_model():
    ...
    model.add(Convolution2D(32, 3, 3, padding='same', activation='relu', name='Conv1'))
    #model.add(BatchNormalization())
    model.add(MaxPooling2D(pool_size=(2, 2), strides=None, padding='same'))
    model.add(Convolution2D(64, 3, 3, padding='same', activation='relu', name='Conv2'))
    #model.add(BatchNormalization())
    model.add(MaxPooling2D(pool_size=(2, 2), strides=None, padding='same'))
    model.add(Convolution2D(128, 3, 3, padding='same', activation='relu', name='Conv3'))
    model.add(MaxPooling2D(pool_size=(2, 2), strides=None, padding='same'))
    #model.add(BatchNormalization())
    model.add(Convolution2D(128, 2, 2, padding='same', activation='relu', name='Conv4'))
    #model.add(BatchNormalization())
    model.add(Flatten())
...
history = model.fit_generator(train_generator, steps_per_epoch=10000, epochs=epoch,
